...
SCHEDULER_WORKER_MODE = _bool_env("SCHEDULER_WORKER_MODE", False)
SCHEDULER_MAX_CYCLES = _int_env("SCHEDULER_MAX_CYCLES", 0)
SCHEDULER_MAX_CONSECUTIVE_FAILURES = _positive(
    "SCHEDULER_MAX_CONSECUTIVE_FAILURES", _int_env("SCHEDULER_MAX_CONSECUTIVE_FAILURES", 10)
)
