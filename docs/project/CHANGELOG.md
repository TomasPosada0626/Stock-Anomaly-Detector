...
- Added dedicated docs under `docs/` by domain.
- Updated guides and operations docs with consistent run and deployment guidance.
...
- Added `Taskfile.yml` for standardized local development and validation commands.
